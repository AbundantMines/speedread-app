...
const CURRICULUM = [
  ...
  { day: 8, week: 2, title: "Reading in Chunks", type: "theory+drill", duration: 10,
    theory: "Instead of reading word-by-word, train your brain to absorb 2-3 words as a single unit. This is how fast readers actually operate. Chunk mode in Warpreader shows 2 words at once — let's practice.",
...
function drawCertificate(improvement) {
  ...
  ctx.fillText('⚡ Warpreader Certified', 400, 90);
